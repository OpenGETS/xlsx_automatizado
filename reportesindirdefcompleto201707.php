...
$query = "CALL FiltroCapaTotalRegSinDirDefv2_comp_xlsx('2017-07');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Sin dir def - 201707')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_sin_dir_def_201707');
...
$objWriter->save('INFORMEMENSUALSINDIRDEF_2017_07.xlsx', __FILE__);
