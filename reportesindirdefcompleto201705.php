...
$query = "CALL FiltroCapaTotalRegSinDirDefv2_comp_xlsx('2017-05');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Sin dir def - 201705')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_sin_dir_def_201705');
...
$objWriter->save('INFORMEMENSUALSINDIRDEF_2017_05.xlsx', __FILE__);
