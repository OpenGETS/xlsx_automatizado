...
$query = "CALL FiltroTablaCapaTotalSinSecv2_comp_xlsx('2017-08');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas 99 - 201708')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas99_201708');
...
$objWriter->save('INFORMEMENSUALNORM99_2017_08.xlsx', __FILE__);
