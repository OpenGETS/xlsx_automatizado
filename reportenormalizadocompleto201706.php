...
$query = "CALL FiltroTablaCapaTotalNorSecv2_comp_xlsx('2017-06');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 201706')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_201706');
...
$objWriter->save('INFORMEMENSUALNORM_2017_06.xlsx', __FILE__);
