...
$query = "CALL FiltroCapaTotalRegSinDirDefv2_comp_xlsx('2017-08');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Sin dir def - 201708')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_sin_dir_def_201708');
...
$objWriter->save('INFORMEMENSUALSINDIRDEF_2017_08.xlsx', __FILE__);
