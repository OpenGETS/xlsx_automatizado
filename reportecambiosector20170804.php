...
$query = "CALL FiltroTablaCapaTotalCambSecv2_xlsx('INFOEMX_SAL_DIR_20170804.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Cambio sector - 20170804')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_cambio_sector_20170804');
...
$objWriter->save('CAMBIOSECTOR20170804.xlsx', __FILE__);
