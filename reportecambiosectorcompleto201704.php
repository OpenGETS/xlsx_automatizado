...
$query = "CALL FiltroTablaCapaTotalCambSecv2_comp_xlsx('2017-04');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Cambio sector - 201704')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_cambio_sector_201704');
...
$objWriter->save('INFORMEMENSUALCAMBIOSECTOR_2017_04.xlsx', __FILE__);
