...
$query = "CALL FiltroTablaCapaTotalNoNormv2_comp_xlsx('2017-05');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - No normalizadas - 201705')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_no_normalizadas_201705');
...
$objWriter->save('INFORMEMENSUALNONORM_2017_05.xlsx', __FILE__);
