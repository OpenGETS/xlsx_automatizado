...
$query = "CALL FiltroCapaTotalRegSinDirDefv2_xlsx('INFOEMX_SAL_DIR_20170715.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Sin dir def - 20170715')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_sin_dir_def_20170715');
...
$objWriter->save('SINDIRDEF20170715.xlsx', __FILE__);
