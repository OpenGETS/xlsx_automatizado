...
$query = "CALL FiltroCapaTotalRegSinDirDefv2_xlsx('INFOEMX_SAL_DIR_20170624.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Sin dir def - 20170624')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_sin_dir_def_20170624');
...
$objWriter->save('SINDIRDEF20170624.xlsx', __FILE__);
