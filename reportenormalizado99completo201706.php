...
$query = "CALL FiltroTablaCapaTotalSinSecv2_comp_xlsx('2017-06');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas 99 - 201706')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas99_201706');
...
$objWriter->save('INFORMEMENSUALNORM99_2017_06.xlsx', __FILE__);
