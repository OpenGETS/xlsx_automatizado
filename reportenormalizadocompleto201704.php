...
$query = "CALL FiltroTablaCapaTotalNorSecv2_comp_xlsx('2017-04');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 201704')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_201704');
...
$objWriter->save('INFORMEMENSUALNORM_2017_04.xlsx', __FILE__);
