...
$query = "CALL FiltroTablaCapaTotal99_comp_xlsx('2017-03');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - A normalizar - 201703')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_a_normalizar_201703');
...
$objWriter->save('INFORMEMENSUALANORM_2017_03.xlsx', __FILE__);
