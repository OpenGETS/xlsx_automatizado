...
$query = "CALL FiltroTablaCapaTotal99_comp_xlsx('2017-06');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - A normalizar - 201706')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_a_normalizar_201706');
...
$objWriter->save('INFORMEMENSUALANORM_2017_06.xlsx', __FILE__);
