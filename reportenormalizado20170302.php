...
$query = "CALL FiltroTablaCapaTotalNorSecv2_xlsx('INFOEMX_SAL_DIR_20170302.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 20170302')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_20170302');
...
$objWriter->save('NORMALIZADAS20170302.xlsx', __FILE__);
