...
$query = "CALL FiltroCapaTotalRegSinDirDefv2_comp_xlsx('2017-03');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Sin dir def - 201703')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_sin_dir_def_201703');
...
$objWriter->save('INFORMEMENSUALSINDIRDEF_2017_03.xlsx', __FILE__);
