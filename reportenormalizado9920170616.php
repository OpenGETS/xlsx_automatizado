...
$query = "CALL FiltroTablaCapaTotalSinSecv2_xlsx('INFOEMX_SAL_DIR_20170616.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas 99 - 20170616')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas99_20170616');
...
$objWriter->save('NORMALIZADAS9920170616.xlsx', __FILE__);
