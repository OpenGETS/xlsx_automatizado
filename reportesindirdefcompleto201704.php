...
$query = "CALL FiltroCapaTotalRegSinDirDefv2_comp_xlsx('2017-04');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Sin dir def - 201704')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_sin_dir_def_201704');
...
$objWriter->save('INFORMEMENSUALSINDIRDEF_2017_04.xlsx', __FILE__);
