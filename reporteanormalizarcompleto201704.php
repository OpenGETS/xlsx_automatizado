...
$query = "CALL FiltroTablaCapaTotal99_comp_xlsx('2017-04');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - A normalizar - 201704')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_a_normalizar_201704');
...
$objWriter->save('INFORMEMENSUALANORM_2017_04.xlsx', __FILE__);
