...
$query = "CALL FiltroTablaCapaTotalNorSecv2_comp_xlsx('2017-05');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 201705')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_201705');
...
$objWriter->save('INFORMEMENSUALNORM_2017_05.xlsx', __FILE__);
