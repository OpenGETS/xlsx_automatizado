...
$query = "CALL FiltroTablaCapaTotalNoNormv2_xlsx('INFOEMX_SAL_DIR_20170301.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - No normalizada - 20170301')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_no_normalizada_20170301');
...
$objWriter->save('NONORMALIZADA20170301.xlsx', __FILE__);
