...
$query = "CALL FiltroTablaCapaTotal99_xlsx('INFOEMX_SAL_DIR_20170712.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - A normalizar - 20170712')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_a_normalizar_20170712');
...
$objWriter->save('ANORMALIZAR20170712.xlsx', __FILE__);
