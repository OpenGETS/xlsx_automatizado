...
$query = "CALL FiltroTablaCapaTotalNoNormv2_comp_xlsx('2017-07');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - No normalizadas - 201707')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_no_normalizadas_201707');
...
$objWriter->save('INFORMEMENSUALNONORM_2017_07.xlsx', __FILE__);
