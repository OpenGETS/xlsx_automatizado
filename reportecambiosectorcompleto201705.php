...
$query = "CALL FiltroTablaCapaTotalCambSecv2_comp_xlsx('2017-05');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Cambio sector - 201705')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_cambio_sector_201705');
...
$objWriter->save('INFORMEMENSUALCAMBIOSECTOR_2017_05.xlsx', __FILE__);
