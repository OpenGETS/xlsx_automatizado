...
$query = "CALL FiltroTablaCapaTotal99_comp_xlsx('2017-07');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - A normalizar - 201707')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_a_normalizar_201707');
...
$objWriter->save('INFORMEMENSUALANORM_2017_07.xlsx', __FILE__);
