...
$query = "CALL FiltroTablaCapaTotalNoNormv2_comp_xlsx('2017-08');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - No normalizadas - 201708')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_no_normalizadas_201708');
...
$objWriter->save('INFORMEMENSUALNONORM_2017_08.xlsx', __FILE__);
