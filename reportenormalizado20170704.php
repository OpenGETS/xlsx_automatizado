...
$query = "CALL FiltroTablaCapaTotalNorSecv2_xlsx('INFOEMX_SAL_DIR_20170704.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 20170704')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_20170704');
...
$objWriter->save('NORMALIZADAS20170704.xlsx', __FILE__);
