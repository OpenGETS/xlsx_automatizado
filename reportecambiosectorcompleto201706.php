...
$query = "CALL FiltroTablaCapaTotalCambSecv2_comp_xlsx('2017-06');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Cambio sector - 201706')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_cambio_sector_201706');
...
$objWriter->save('INFORMEMENSUALCAMBIOSECTOR_2017_06.xlsx', __FILE__);
