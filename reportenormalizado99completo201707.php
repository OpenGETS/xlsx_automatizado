...
$query = "CALL FiltroTablaCapaTotalSinSecv2_comp_xlsx('2017-07');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas 99 - 201707')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas99_201707');
...
$objWriter->save('INFORMEMENSUALNORM99_2017_07.xlsx', __FILE__);
