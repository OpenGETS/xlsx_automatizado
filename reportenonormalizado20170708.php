...
$query = "CALL FiltroTablaCapaTotalNoNormv2_xlsx('INFOEMX_SAL_DIR_20170708.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - No normalizada - 20170708')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_no_normalizada_20170708');
...
$objWriter->save('NONORMALIZADA20170708.xlsx', __FILE__);
