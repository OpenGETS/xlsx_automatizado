...
$ews->setCellValue('C1', 'NOMBRE_EJEC');
$ews->setCellValue('D1', 'ZONA_EJEC');
$ews->setCellValue('E1', 'CENTRO_EJEC');
$ews->setCellValue('F1', 'DIR');
$ews->setCellValue('G1', 'CALLE');
$ews->setCellValue('H1', 'NUMERO');
$ews->setCellValue('I1', 'COD_COMUNA');
$ews->setCellValue('J1', 'DESC_COMUNA');
$ews->setCellValue('K1', 'COD_CIUDAD');
$ews->setCellValue('L1', 'COD_REGION');
$ews->setCellValue('M1', 'DESC_REGION');
$ews->setCellValue('N1', 'LATITUD');
$ews->setCellValue('O1', 'LONGITUD');
$ews->setCellValue('P1', 'SECTOR');
$ews->setCellValue('Q1', 'OBS');
...
$objWriter->save('ANORMALIZAR20170301.xlsx', __FILE__);
...
// REPORTE A NORMALIZAR - 20170301
$query = "CALL FiltroTablaCapaTotal99_xlsx('INFOEMX_SAL_DIR_20170302.TXT');";
mysqli_set_charset($connect, 'utf8');
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - A normalizar - 20170302')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_a_normalizar_20170302');
$ews->setCellValue('A1', 'RUT CLIENTE');
$ews->setCellValue('B1', 'ID_COR');
$ews->setCellValue('C1', 'NOMBRE_EJEC');
$ews->setCellValue('D1', 'ZONA_EJEC');
...
$objWriter = PHPExcel_IOFactory::createWriter($ea, 'Excel2007');
$objWriter->save('ANORMALIZAR20170302.xlsx', __FILE__);
