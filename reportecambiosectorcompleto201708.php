...
$query = "CALL FiltroTablaCapaTotalCambSecv2_comp_xlsx('2017-08');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Cambio sector - 201708')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_cambio_sector_201708');
...
$objWriter->save('INFORMEMENSUALCAMBIOSECTOR_2017_08.xlsx', __FILE__);
