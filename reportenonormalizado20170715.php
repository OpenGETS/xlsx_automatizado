...
$query = "CALL FiltroTablaCapaTotalNoNormv2_xlsx('INFOEMX_SAL_DIR_20170715.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - No normalizada - 20170715')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_no_normalizada_20170715');
...
$objWriter->save('NONORMALIZADA20170715.xlsx', __FILE__);
