...
$query = "CALL FiltroTablaCapaTotalNorSecv2_xlsx('INFOEMX_SAL_DIR_20170305.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 20170305')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_20170305');
...
$objWriter->save('NORMALIZADAS20170305.xlsx', __FILE__);
