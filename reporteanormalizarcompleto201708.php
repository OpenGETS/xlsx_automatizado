...
$query = "CALL FiltroTablaCapaTotal99_comp_xlsx('2017-08');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - A normalizar - 201708')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_a_normalizar_201708');
...
$objWriter->save('INFORMEMENSUALANORM_2017_08.xlsx', __FILE__);
