...
$query = "CALL FiltroTablaCapaTotal99_xlsx('INFOEMX_SAL_DIR_20170801.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - A normalizar - 20170801')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_a_normalizar_20170801');
...
$objWriter->save('ANORMALIZAR20170801.xlsx', __FILE__);
