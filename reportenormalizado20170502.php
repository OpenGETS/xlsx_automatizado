...
$query = "CALL FiltroTablaCapaTotalNorSecv2_xlsx('INFOEMX_SAL_DIR_20170502.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 20170502')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_20170502');
...
$objWriter->save('NORMALIZADAS20170502.xlsx', __FILE__);
