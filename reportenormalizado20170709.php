...
$query = "CALL FiltroTablaCapaTotalNorSecv2_xlsx('INFOEMX_SAL_DIR_20170709.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 20170709')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_20170709');
...
$objWriter->save('NORMALIZADAS20170709.xlsx', __FILE__);
