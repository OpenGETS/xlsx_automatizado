...
$query = "CALL FiltroTablaCapaTotalCambSecv2_comp_xlsx('2017-07');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Cambio sector - 201707')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_cambio_sector_201707');
...
$objWriter->save('INFORMEMENSUALCAMBIOSECTOR_2017_07.xlsx', __FILE__);
