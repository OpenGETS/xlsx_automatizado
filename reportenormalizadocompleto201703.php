...
$query = "CALL FiltroTablaCapaTotalNorSecv2_comp_xlsx('2017-03');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Normalizadas - 201703')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_normalizadas_201703');
...
$objWriter->save('INFORMEMENSUALNORM_2017_03.xlsx', __FILE__);
