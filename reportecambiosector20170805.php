...
$query = "CALL FiltroTablaCapaTotalCambSecv2_xlsx('INFOEMX_SAL_DIR_20170805.TXT');";
...
$ea->getProperties()
    ->setCreator('OpenGETS')
    ->setTitle('Reporte - Cambio sector - 20170805')
    ->setLastModifiedBy('Joaquín Macías Cáceres');
$ews = $ea->getSheet(0);
$ews->setTitle('Reporte_cambio_sector_20170805');
...
$objWriter->save('CAMBIOSECTOR20170805.xlsx', __FILE__);
